...
import { get_active_deployment_details, subscribe_for_glider_connection, subscribe_for_glider_dialog } from './sfmc_api.mjs'
...
export { update_glider_positions, update_glider_waypoint, delete_old_tracks, subscribe_sfmc_gliders }
